...
def generate_test_data(num_records):
    ...
    for i in range(num_records):
        ...
        yield a, b, operation_name, operation_fun, expected
...
def pytest_generate_tests(metafunc):
    if {"a", "b", "expected"}.intersection(set(metafunc.fixturenames)):
        ...
        modified_parameters = [(a, b, op_name if 'operation_name' in metafunc.fixturenames else op_func, expected) for a, b, op_name, op_func, expected in params]
